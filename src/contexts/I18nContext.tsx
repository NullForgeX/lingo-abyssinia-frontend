...
const translations: Record<UILanguage, Record<string, string>> = {
  ...
  amharic: {
    ...
    "app.aiChat": "የAI ውይይት",
    "app.learner": "ተማሪ",
    "app.interfaceLanguage": "የመተግበሪያ ቋንቋ",
    "app.selected": "ተመርጧል",
    "app.showSidebar": "የጎን ምናሌ አሳይ",
    "app.hideSidebar": "የጎን ምናሌ ደብቅ",
    "app.openSidebar": "ምናሌ ክፈት",
    "app.closeSidebar": "ምናሌ ዝጋ",
  ...
  oromo: {
    ...
    "app.lessons": "Barnoota",
    "app.aiChat": "Marii AI",
    "app.learner": "Barataa",
    "app.interfaceLanguage": "Afaan fuula",
    "app.selected": "filatame",
    "app.showSidebar": "Baafata cinaa agarsiisi",
    "app.hideSidebar": "Baafata cinaa dhoksi",
    "app.openSidebar": "Baafata bani",
    "app.closeSidebar": "Baafata cufi",
  ...
  tigrinya: {
    ...
    "app.aiChat": "AI ዕላል",
    "app.learner": "ተማሃራይ",
    "app.interfaceLanguage": "ቋንቋ መተግበሪ",
    "app.selected": "ተመሪጹ",
    "app.showSidebar": "ጎናዊ ምናሌ ኣርኢ",
    "app.hideSidebar": "ጎናዊ ምናሌ ሕባእ",
    "app.openSidebar": "ምናሌ ክፈት",
    "app.closeSidebar": "ምናሌ ዕጾ",
