...
Object.assign(translations.english, {
  ...
  "learn.backHome": "Back to Home",
  "learn.clearPath": "Clear path: finish one lesson to unlock the next.",
  "learn.review": "Review",
  "learn.start": "Start",
  "learn.locked": "Locked",
  ...
  "home.languageSelectionDesc": "Pick or update your learning language.",
  "home.streakHistory": "Streak History",
  "home.streakHistoryDesc": "See your daily practice consistency.",
  "home.badgeHistory": "Badge History",
  "home.badgeHistoryDesc": "Review badges and milestones earned.",
  "home.skillChart": "Per-Skill Chart",
  "home.skillChartDesc": "Track progress across core skills.",
});

Object.assign(translations.amharic, {
  "app.home": "መነሻ",
  "app.community": "ማህበረሰብ",
  "learn.startNext": "ቀጣይ ትምህርት ጀምር",
  "learn.courseCompleted": "ኮርሱ ተጠናቀቀ",
  "learn.changeLanguage": "ቋንቋ ቀይር",
  "learn.backHome": "ወደ መነሻ ተመለስ",
  "learn.clearPath": "ግልጽ መንገድ: አንድ ትምህርት ጨርሰህ ቀጣዩን ክፈት።",
  "learn.review": "ግምገማ",
  "learn.start": "ጀምር",
  "learn.locked": "ተዘግቷል",
  "home.goToLearn": "ወደ ትምህርት ሂድ",
  "home.quickAccess": "ፈጣን መዳረሻ",
  "home.generalInfo": "ጠቅላላ መረጃ",
  "home.open": "ክፈት",
  "home.languageSelection": "ቋንቋ ምርጫ",
  "home.languageSelectionDesc": "የምትማርበትን ቋንቋ ምረጥ ወይም አዘምን።",
  "home.streakHistory": "የተከታታይ ታሪክ",
  "home.streakHistoryDesc": "የዕለታዊ ልምድህን ተከታተል።",
  "home.badgeHistory": "የባጅ ታሪክ",
  "home.badgeHistoryDesc": "ያገኘሃቸውን ሽልማቶች ተመልከት።",
  "home.skillChart": "የክህሎት ግራፍ",
  "home.skillChartDesc": "በተለያዩ ክህሎቶች ውስጥ እድገትህን አይ።",
});

Object.assign(translations.oromo, {
  "app.home": "Mana",
  "app.community": "Hawaasa",
  "learn.startNext": "Barnoota itti aanu jalqabi",
  "learn.courseCompleted": "Koorsiin xumurame",
  "learn.changeLanguage": "Afaan jijjiiri",
  "learn.backHome": "Gara Manaatti Deebi'i",
  "learn.clearPath": "Karaa ifaa: barnoota tokko xumuri, kan itti aanu bana.",
  "learn.review": "Irra deebi'i",
  "learn.start": "Jalqabi",
  "learn.locked": "Cufame",
  "home.goToLearn": "Gara Baradhu deemi",
  "home.quickAccess": "Saffisaan seeni",
  "home.generalInfo": "Odeeffannoo waliigalaa",
  "home.open": "Bani",
  "home.languageSelection": "Filannoo Afaanii",
  "home.languageSelectionDesc": "Afaan barachuu filadhu ykn haaromsi.",
  "home.streakHistory": "Seenaa Hordoffii",
  "home.streakHistoryDesc": "Itti fufiinsa barnoota kee ilaali.",
  "home.badgeHistory": "Seenaa Badge",
  "home.badgeHistoryDesc": "Milkaa'ina fi badge argatte ilaali.",
  "home.skillChart": "Chaartii Dandeettii",
  "home.skillChartDesc": "Dandeettii adda addaa keessatti guddina hordofi.",
});

Object.assign(translations.tigrinya, {
  "app.home": "መበገሲ",
  "app.community": "ማሕበረሰብ",
  "learn.startNext": "ቀጻሊ ትምህርቲ ጀምር",
  "learn.courseCompleted": "ኮርስ ተዛዚሙ",
  "learn.changeLanguage": "ቋንቋ ቀይር",
  "learn.backHome": "ናብ መበገሲ ተመለስ",
  "learn.clearPath": "ንጹር መንገዲ: ሓደ ትምህርቲ ኣጠናቂ ቀጻሊ ክፈት።",
  "learn.review": "ግምገማ",
  "learn.start": "ጀምር",
  "learn.locked": "ተለዩ",
  "home.goToLearn": "ናብ ትምህርቲ ኪድ",
  "home.quickAccess": "ቅልጡፍ መብጻሕ",
  "home.generalInfo": "ሓፈሻዊ ሓበሬታ",
  "home.open": "ክፈት",
  "home.languageSelection": "ምርጫ ቋንቋ",
  "home.languageSelectionDesc": "ትምህርቲ ዝምሃርካ ቋንቋ ምረጽ ወይ ኣዘምን።",
  "home.streakHistory": "ታሪኽ ተኸታታሊ",
  "home.streakHistoryDesc": "ዕለታዊ ልምድካ ተኸታተል።",
  "home.badgeHistory": "ታሪኽ ባጅ",
  "home.badgeHistoryDesc": "ዝተረኸበካ ሽልማት ርአ።",
  "home.skillChart": "ሰንጠረዥ ክህሎት",
  "home.skillChartDesc": "ኣብ ዝተፈላለዩ ክህሎታት ዕብየት ተኸታተል።",
});
