    ...
    <div className="flex min-h-screen bg-background md:h-screen md:overflow-hidden">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <aside className="absolute left-0 top-0 h-full w-[min(18rem,85vw)] bg-background shadow-xl">
      ...
      <div className="flex min-w-0 min-h-0 flex-1 flex-col">
        ...
        <main data-scroll-container className="flex-1 overflow-y-auto p-4 md:p-8">
          <Outlet />
        </main>
      </div>
    </div>
